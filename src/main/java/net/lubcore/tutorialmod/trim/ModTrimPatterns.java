package net.lubcore.tutorialmod.trim;
...
public class ModTrimPatterns {
    public static final RegistryKey<ArmorTrimPattern> CORE = RegistryKey.of(RegistryKeys.TRIM_PATTERN,
            Identifier.of(TutorialMod.MOD_ID, "core"));

    public static void bootstrap(Registerable<ArmorTrimPattern> context) {
        register(context, ModItems.CORE_SMITHING_TEMPLATE, CORE);
    }
